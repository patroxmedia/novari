                                            ...
                                            <div className="col-lg-12">
                                                <div className="card-feature-2">
                                                    ...
                                                    <div className="card-info">
                                                        ...
                                                        <div className="text-md neutral-700">
                                                            <div className="row">
                                                                <div className="col-sm-6"><Link className="neutral-700" href="/mailto:sale@patroxmedia.com">sale@patroxmedia.com</Link></div>
                                                                <div className="col-sm-6"><Link className="neutral-700" href="/mailto:contact@patroxmedia.com">contact@patroxmedia.com</Link></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
