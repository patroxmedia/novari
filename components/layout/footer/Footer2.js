        ...
        <>
            <footer className="footer footer-style-2 mt-50">
                <div className="container">
                    <div className="row">
                        <div className="col-md-3 col-sm-12 footer-1"><Link href="/"><img alt="Novari" className='footer-logo' src="/assets/imgs/template/logo-black.png" /></Link>
                    ...
                    <div className="footer-bottom mt-50">
                        <div className="row">
                            <div className="col-md-6">
                                <p className="text-sm neutral-600">Copyright © 2024 Patroxmedia. All rights reserved.</p>
                            </div>
